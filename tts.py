...
while True:
	...
	if text.count(WAKE)>0:
		speak("I am ready!")
		text = get_audio()
		#when to call the get_events function
		CAL = ["what do i have", "do i have plans", "am i busy"]
		for phrase in CAL:
			if phrase in text:
				date = get_date(text)
				print(date)
		...
		NOTE = ["take this down", "note down", "note this down", "write this down", "remember this"]
		for phrase in NOTE:
